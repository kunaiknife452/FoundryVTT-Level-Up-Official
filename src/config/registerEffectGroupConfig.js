  ...
  A5E.effectKeyGroups = {
    ...
    resources: {
      ...
      items: [
        ...
        'system.resources.senary.hideMax',
        'system.resources.senary.label',
        'system.resources.senary.max',
        'system.resources.senary.per',
        'system.resources.senary.recharge.formula',
        'system.resources.senary.recharge.threshold',
        'system.resources.senary.value',
        'system.resources.septenary.hideMax',
        'system.resources.septenary.label',
        'system.resources.septenary.max',
        'system.resources.septenary.per',
        'system.resources.septenary.recharge.formula',
        'system.resources.septenary.recharge.threshold',
        'system.resources.septenary.value',
        'system.resources.octonary.hideMax',
        'system.resources.octonary.label',
        'system.resources.octonary.max',
        'system.resources.octonary.per',
        'system.resources.octonary.recharge.formula',
        'system.resources.octonary.recharge.threshold',
        'system.resources.octonary.value',
        'system.resources.quinary.hideMax',
        'system.resources.quinary.label',
        'system.resources.quinary.max',
        'system.resources.quinary.per',
        'system.resources.quinary.recharge.formula',
        'system.resources.quinary.recharge.threshold',
        'system.resources.quinary.value',
