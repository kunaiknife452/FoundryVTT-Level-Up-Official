...
export default function registerEffectLocalizationConfig(A5E) {
  A5E.effectsKeyLocalizations = {
    ...
    'system.resources.quinary.hideMax': 'A5E.effects.keys.resources.quinary.hideMax',
    'system.resources.quinary.label': 'A5E.effects.keys.resources.quinary.label',
    'system.resources.quinary.max': 'A5E.effects.keys.resources.quinary.max',
    'system.resources.quinary.per': 'A5E.effects.keys.resources.quinary.per',
    'system.resources.quinary.recharge.formula': 'A5E.effects.keys.resources.quinary.rechargeFormula',
    'system.resources.quinary.recharge.threshold': 'A5E.effects.keys.resources.quinary.rechargeThreshold',
    'system.resources.quinary.value': 'A5E.effects.keys.resources.quinary.value',
    'system.resources.senary.hideMax': 'A5E.effects.keys.resources.senary.hideMax',
    'system.resources.senary.label': 'A5E.effects.keys.resources.senary.label',
    'system.resources.senary.max': 'A5E.effects.keys.resources.senary.max',
    'system.resources.senary.per': 'A5E.effects.keys.resources.senary.per',
    'system.resources.senary.recharge.formula': 'A5E.effects.keys.resources.senary.rechargeFormula',
    'system.resources.senary.recharge.threshold': 'A5E.effects.keys.resources.senary.rechargeThreshold',
    'system.resources.senary.value': 'A5E.effects.keys.resources.senary.value',
    'system.resources.septenary.hideMax': 'A5E.effects.keys.resources.septenary.hideMax',
    'system.resources.septenary.label': 'A5E.effects.keys.resources.septenary.label',
    'system.resources.septenary.max': 'A5E.effects.keys.resources.septenary.max',
    'system.resources.septenary.per': 'A5E.effects.keys.resources.septenary.per',
    'system.resources.septenary.recharge.formula': 'A5E.effects.keys.resources.septenary.rechargeFormula',
    'system.resources.septenary.recharge.threshold': 'A5E.effects.keys.resources.septenary.rechargeThreshold',
    'system.resources.septenary.value': 'A5E.effects.keys.resources.septenary.value',
    'system.resources.octonary.hideMax': 'A5E.effects.keys.resources.octonary.hideMax',
    'system.resources.octonary.label': 'A5E.effects.keys.resources.octonary.label',
    'system.resources.octonary.max': 'A5E.effects.keys.resources.octonary.max',
    'system.resources.octonary.per': 'A5E.effects.keys.resources.octonary.per',
    'system.resources.octonary.recharge.formula': 'A5E.effects.keys.resources.octonary.rechargeFormula',
    'system.resources.octonary.recharge.threshold': 'A5E.effects.keys.resources.octonary.rechargeThreshold',
    'system.resources.octonary.value': 'A5E.effects.keys.resources.octonary.value',
